...
const Review = (props) => {
	...
	return (
		<>
			...
			<div className="review-description">{body}</div>
			{body.length === 250 ? (
				<div
					onClick={() => {
			...
			<div className="footer">
				{props.review.recommend === 1 ? (
					<div className="review-recommend">
						I recommend this product <i className="material-icons">check</i>
					</div>
				) : (
					<div />
				)}
...
const Review = props => {
    ...
    return (
        ...
        {(props.review.response) ? <Response response={props.review.response}/> : <div/>}
        <div className="footer">
            {(props.review.recommend === 1) ? <div className="review-recommend">I recommend this product <i className="material-icons" style={{position: "relative",
    top: "5px"}}>check</i></div> : <div/>}
            <div className="footer-buttons">
                <div className="helpful">
                    <Helpful review={props.review}/>
                </div>
...
export default Review
>>>>>>> 5b4c4f76e3e998b172991e839ad25ac7bc87134f
