...
const Review = props => {
    ...
    return (
        ...
        {(body.length === 250) ?  <div onClick={setBody(props.review.body)} style={{display: 'flex'}}>expand</div> : <div/>}
        ...
        <div className="footer">
            {(props.review.recommend === 1) ? <div className="review-recommend">I recommend this product <i className="material-icons">check</i></div> : <div/>}
