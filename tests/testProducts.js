// Corresponds to product 1 on the API
const testProduct = {
	id: 1,
	name: "Camo Onesie",
		...
		results: [
			{
				...
				response: null,
				body:
					"It's alright and it does the job well. djakld aejlkdja lkejfelkf sklefjeslkf fslkfjes",
			...
			},
			{
				...
				response: null,
				body:
					" sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd v  sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd v  sdfka sasd asdfd sddsd dsds dasd ssd ddd sdfka sasd asdfd sddsd dsds dasd ssd ddd sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd  sdfka sasd asdfd sddsd dsds dasd ssd ddd",
				date: "2019-09-11T00:00:00.000Z",
				reviewer_name: "jjjjjjj",
				helpfulness: 0,
				photos: [
					{
						id: 27142,
						url: "https://cdn.filestackcontent.com/6JImOPlzRHWmwUtP4IM1",
					},
				],
			},
			{
			...
			},
			{
				review_id: 57363,
				rating: 2,
				summary: "I loved it so muchhhh",
				recommend: 1,
				response: null,
				body: "I can't stand it.",
				date: "2019-09-12T00:00:00.000Z",
				reviewer_name: "jjjjjj",
				helpfulness: 0,
				photos: [
					{
						id: 27143,
						url: "https://cdn.filestackcontent.com/DVQgEVCQMKiQbUSu7hiX",
					},
				],
			},
			{
				review_id: 57364,
				rating: 5,
				summary: "Summarily Great",
				recommend: 1,
				response: null,
				body:
					"I can say that this is the best product I have ever seen. I am not one for hyperbole, but this product solved my financial troubles, helped me find a new love interest, and straightened out a dispute with my landlord.",
				date: "2019-09-12T00:00:00.000Z",
				reviewer_name: "StraightTalker",
				helpfulness: 0,
				photos: [
					{
						id: 27144,
						url: "https://cdn.filestackcontent.com/MxuACu1jQReWbOJU7ebu",
					},
				],
			},
		],
	...
	questions: [
		{
			...
			answers: {
				...
				"124816": {
					...
					body: "test",
					date: "2019-09-04T00:00:00.000Z",
					answerer_name: "Bailey",
					helpfulness: 0,
					photos: [],
				},
				"124826": {
					id: 124826,
					body: "yes but do not tumble dry ",
					date: "2019-09-13T00:00:00.000Z",
					answerer_name: "notumbler",
					helpfulness: 0,
					photos: [],
				},
			},
